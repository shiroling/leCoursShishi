...
package body paquetage_Mot is
   ...
   begin
      --  --put("m1=");Put_Line(m1.mot (1 .. LONGUEUR_NOM));
      --  --put("m2=");Put_Line(m2.mot (1 .. LONGUEUR_NOM)); if longueur(m1)
      --  if longueur(m1) = longueur(m1) then
      --     --put_line("meme longeur");
   ...
   function clef (m : in Mot) return integer is
   begin
      return 0;
   end clef;
