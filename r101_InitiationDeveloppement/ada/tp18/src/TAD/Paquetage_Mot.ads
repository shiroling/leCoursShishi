package paquetage_Mot is
   ...
   --crèe un nouveau mot par concaténation les 2 mots m1 et m2
   --nécessite longueur(m1) + longueur(m2) <= LONGUEUR_MOT
   ...
   -- retourne le ième caractère du mot m nècessite i>0
   ...
   -- retourne la clef du mot m
   -- entraine : cette clef est comprise entre 1 et taille maximum du tableau où stocker m
   function clef (m : in Mot) return integer ;
