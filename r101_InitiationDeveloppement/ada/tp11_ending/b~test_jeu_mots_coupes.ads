...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_jeu_mots_coupes" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#11ef41f9#;
   pragma Export (C, u00001, "test_jeu_mots_coupesB");
   ...
   u00137 : constant Version_32 := 16#15ca94c6#;
   pragma Export (C, u00137, "paquetage_dictionnaireB");
   u00138 : constant Version_32 := 16#e754bdc5#;
   pragma Export (C, u00138, "paquetage_dictionnaireS");
   u00139 : constant Version_32 := 16#4fef17d1#;
   pragma Export (C, u00139, "paquetage_motB");
   u00140 : constant Version_32 := 16#b52940f1#;
   pragma Export (C, u00140, "paquetage_motS");
   ...
   u00143 : constant Version_32 := 16#4582cee8#;
   pragma Export (C, u00143, "paquetage_jeuB");
   u00144 : constant Version_32 := 16#b8e639d0#;
   pragma Export (C, u00144, "paquetage_jeuS");
   ...
   --  paquetage_mot%s
   --  paquetage_mot%b
   --  paquetage_dictionnaire%s
   --  paquetage_dictionnaire%b
   --  paquetage_jeu%s
   --  paquetage_jeu%b
   --  test_jeu_mots_coupes%b
