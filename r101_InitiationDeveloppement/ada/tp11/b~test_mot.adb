pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_mot.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_mot.adb");
...
package body ada_main is
   ...
   E138 : Short_Integer; pragma Import (Ada, E138, "paquetage_mot_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_mot");
