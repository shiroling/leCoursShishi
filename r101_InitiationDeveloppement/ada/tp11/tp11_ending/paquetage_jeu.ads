...
package paquetage_jeu is
   ...
   -- en recherchant dans le dictionnaire dico tous les mots qu'il est possible
   -- de construire par concatenation des racines de 3 lettres qui se trouvent
   -- dans la grille
   procedure construire_mots
     (grille         : in     dictionnaire; dico : in dictionnaire;
      mots_a_trouver :    out dictionnaire);

   -- retourne VRAI si tous mots qui se trouvent dans le dictionnaire d1 se
   -- trouvent aussi dans le dictionnaire d2 et FAUX sinon
   ...
   -- se trouvent aussi dans le dictionnaire d2 et si tous les mots qui se
   -- trouvent dans d2 se trouvent aussi dans le dictionnaire d1 et FAUX sinon
