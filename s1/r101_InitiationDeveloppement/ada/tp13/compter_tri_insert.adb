with Ada.Float_Text_Io, Ada.Integer_Text_Io, Ada.Text_Io, Ada.Numerics.Float_Random, Compteurs, Tableau, compter_tris, tris;
use Ada.Float_Text_Io, Ada.Integer_Text_Io, Ada.Text_Io, Ada.Numerics.Float_Random, Compteurs, Tableau, compter_tris, tris;
...
begin
   ...
   Reset (G);
   Create (Fic, Name => "txts/insert.txt");
   ...
   for Lg in 1..T'Last loop
      ...
      for I in 1..Nb_Tris loop
         ...
         tri_insertion_cpt(T(1..Lg), Cpt_Comp, Cpt_Affec);
      end loop;
